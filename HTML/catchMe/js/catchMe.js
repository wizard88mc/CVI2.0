...
function GameSettings() {
	...
	this.percentualImageWidth = 0; // percentage of the image width, used for CSS
...
timingFunction: function() {
	...
	if (!gameManager.gameInAction) {
		...
		CatchMeNamespace.allExercisesCompleted();
	}
...
startGame: function() {
	...
	//addGeneralSound(audioExplanation, '../sounds/paperino');
...
allExercisesCompleted: function() {

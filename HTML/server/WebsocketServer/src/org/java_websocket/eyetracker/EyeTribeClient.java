...
public class EyeTribeClient {
    ...
    private class CalibrationManager implements ICalibrationProcessHandler {
         ...
         */
        public ArrayList<Point> calculateCalibrationPoints(int pointsNumber, 
                long pointDuration, long transitionDuration, int imageWidth) {
            ...
            int screenWidth = ((Long) EyeTrackerManager.packetWithScreenDimension.get("SCREEN_WIDTH")).intValue();
            int screenHeight = ((Long) EyeTrackerManager.packetWithScreenDimension.get("SCREEN_HEIGHT")).intValue();
        ...
        public void onCalibrationResult(CalibrationResult calibResult) {
            ...
            System.out.println("Average error degree: " + 
            ...
            for (int i = 0; i < calibResult.calibpoints.length; i++) {
                ...
                System.out.println("X position: " + 
                        calibResult.calibpoints[i].coordinates.x + 
                        ", Y Position: " + 
                        calibResult.calibpoints[i].coordinates.y);
                
                System.out.println("X estimated: " + 
                        calibResult.calibpoints[i].meanEstimatedCoords.x + 
                        ", Y position: " + 
                        calibResult.calibpoints[i].meanEstimatedCoords.y);
            }
    ...
    private class TrackerStateListener implements ITrackerStateListener {
        ...
        public void onTrackerStateChanged(int trackerState) {
            ...
            if (GazeManager.TrackerState.fromInt(trackerState) == 
                ...
                System.out.println("Tracker connected not to USB3");
            }
            else if (GazeManager.TrackerState.fromInt(trackerState) == 
        ...
        public void OnScreenStatesChanged(int screenIndex, 
            ...
            System.out.println("PX Width: " + screenResolutionWidth + 
                    ", PX Height: " + screenResolutionHeight);
        }
    }

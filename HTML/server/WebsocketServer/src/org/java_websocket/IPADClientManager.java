...
public class IPADClientManager extends WebSocketWithOffsetCalc {
    ...
    public boolean onMessage(WebSocket conn, String message) {
        ...
        if (packet.get(BaseManager.MESSAGE_TYPE).equals(BaseManager.IDENTIFICATION) 
                && clientConnected != null) {
            patientManager = this;
            BaseManager.childClientConnected = true;
        }
        if (!alreadyManaged) {
            ...
            if (packetType.equals("GAME_DATA")) {
                ...
                if (eyeTrackerManager != null) {
                    ...
                    packetStartTraining.put(BaseManager.MESSAGE_TYPE, 
                            "TRAINING_SESSION");
                    ...
                    packetEyeTrackerNotReady.put(BaseManager.MESSAGE_TYPE, 
                            "EYE_TRACKER_NOT_READY");
    ...
    public void writeGameSpecs() {
        messageManager.writeGameSpecs(imageWidth, imageHeight, screenWidth, 
                screenHeight);
    }

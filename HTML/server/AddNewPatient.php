...
$nameForPassword = preg_replace('/\s+/', '', $patientName);
$surnameForPassword = preg_replace('/\s+/', '', $patientSurname);

$username = strtolower($nameForPassword) . '.' . strtolower($surnameForPassword);
$password = md5(strtolower($surnameForPassword) . $dayBirth . $monthBirth);
